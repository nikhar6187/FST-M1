...
public class Activity2 {
    ...
    public void getUserInfo() throws IOException {
        ...
        Response response = 
            ...
            .pathParam("username", "nikhar vijayvargiya")
        ...
        response.then().body("username", equalTo("nikhar vijayvargiya"));
        response.then().body("firstName", equalTo("nikhar"));
        response.then().body("lastName", equalTo("vijay"));
        response.then().body("email", equalTo("nikhar vijayvargiya@gmail.com"));
    ...
    public void deleteUser() throws IOException {
        Response response = 
            given().contentType(ContentType.JSON) // Set headers
            .pathParam("username", "nikhar vijayvargiya") // Add path parameter
            .when().delete(ROOT_URI + "/{username}"); // Send POST request

        // Assertion
        response.then().body("code", equalTo(200));
        response.then().body("message", equalTo("nikhar vijayvargiya"));
    }
